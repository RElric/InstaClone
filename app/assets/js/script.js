...
var fakeLinks = document.getElementsByClassName('fake-link'), btnCon = document.getElementById('btnCon'), inpEmail = document.getElementById('email'), inpMDP = document.getElementById('mdp');
/****************************** FUNCTIONS ******************************/
...
function verifMDP() {
    var reMDP = /^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])([a-zA-Z0-9]{5,})$/;
